...
add_block('simulink/Dashboard/Subgroup Block', engineParams);
...
add_block('simulink/Dashboard/Subgroup Block', pumpParams);
...
add_block('simulink/Dashboard/Subgroup Block', controllerParams);
...
add_block('simulink/Dashboard/Subgroup Block', pidParams);
...
add_block('simulink/Dashboard/Subgroup Block', loadParams);
...
add_block('simulink/Dashboard/Subgroup Block', ambientParams);
